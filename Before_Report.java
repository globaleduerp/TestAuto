...
public class Before_Report {

	public void Before_Report1(WebDriver driver, WebDriverWait wait) throws InterruptedException, IOException {
...
//	        driver.findElement(By.id("btnLogin")).click();
		   driver.findElement(By.xpath("//span[text()='Reports']")).click();
					...
					for(String windowhandle:windowhandles)
					{
						...
						System.out.println("...........................................");
						String filePath="G:\\document\\selenium_maven\\target\\Emp Salary Modulee.xlsx";						
						int x=1;	
