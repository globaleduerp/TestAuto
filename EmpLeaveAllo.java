...
public void EmpLeaveAllo1(WebDriver driver, WebDriverWait wait) throws InterruptedException, IOException {
...
//			String LeaveType=Excelutils.getCellData(filePath, "Emp Allowance",i,1);
			String Employee=Excelutils.getCellData(filePath, "Emp Allowance",i,1);
			String Leave=Excelutils.getCellData(filePath,"Emp Allowance",i,2);
...
//	     try { 
			   ...
			   if(error.getText().contains("Sucessfullly"))
             {
		    	 ...
		    	 Excelutils.setCellData(filePath, "Emp Allowance",i,3,"Pass");
		    	 Excelutils.setCellData(filePath, "Emp Allowance",i,4,error.getText());
...
//				   if(error1.getText().contains("Some error"))
		    	 ...
		    	 Excelutils.setCellData(filePath, "Emp Allowance",i,3, "Pass with error");
		    	 Excelutils.setCellData(filePath, "Emp Allowance",i,4,error.getText());
		    	 Excelutils.fillRedColor(filePath, "Emp Allowance",i,4);
